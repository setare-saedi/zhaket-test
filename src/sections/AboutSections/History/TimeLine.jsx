                            ...
                            >
                                <div class='text-center  '>
                                    <div className={`${activeTab === child.props.label ? ' relative bg-[#464E58] text-white pr-4 pl-3 rounded-md text-xs  ' : ''
                                        } mb-4 text-[#76767C] text-xs w-fit mx-auto tracking-tighter pt-[7px] pb-[9px] transition-all  duration-200 ease-linear`} >
                                        {child.props.label}
                                    ...
                                    <div className={`${activeTab === child.props.label ? 'mt-2 font-bold text-[22px] ' : 'mt-5 text-xs '}  transition-all duration-300 ease-linear`}>
                                        {child.props.year}
                                    </div>
                                </div>
                            </button>
