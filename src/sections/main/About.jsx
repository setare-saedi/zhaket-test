  ...
  return (
    <div>
        <div className='flex flex-row justify-between items-end mx-20 relative'>
          <div className='bg-[#FFF1ED] w-fit text-center rounded-2xl border-solid border-4 border-white absolute top-0 drop-shadow-xl '>
          ...
          <div className='bg-[#F0F8FF] relative border-4 border-white rounded-2xl px-8 pb-6 ml-16 shadow-xl pt-16 '>
            <div className='text-[115px]  absolute bottom-[40%] text-[#878F9B]'>,,</div>
