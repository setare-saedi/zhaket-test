    ...
    return (
        <div className='flex flex-row justify-between items-end  relative '>
            ...
            <div className='bg-[#F0F8FF] relative border-4 border-white rounded-2xl pr-6 pl-8 pb-6 ml-16 shadow-xl pt-16 w-[429px] '>
                ...
                <div className='text-xs my-4 tracking-tighter text-[#424244] pr-2 animate-timeLineAnimation '>
                    {text}
                </div>
                <div className='font-bold text-[#878F9B] text-xs pr-2 tracking-tighter animate-timeLineAnimation'>
                    {name}
                </div>
            </div>
            <div>
